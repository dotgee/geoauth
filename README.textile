...
Preferences:
{:git=>true, :railsapps=>"none", :dev_webserver=>"unicorn", :prod_webserver=>"unicorn", :database=>"postgresql", :templates=>"slim", :unit_test=>"rspec", :integration=>"rspec-capybara", :fixtures=>"factory_girl", :frontend=>"bootstrap", :bootstrap=>"sass", :email=>"smtp", :authentication=>"devise", :devise_modules=>"invitable", :authorization=>"none", :form_builder=>"simple_form", :starter_app=>"users_app", :quiet_assets=>true, :ban_spiders=>true, :jsruntime=>false}
